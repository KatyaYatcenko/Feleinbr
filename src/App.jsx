...
export default function App() {
  ...
  async function handleClearChat() {
    ...
    const confirmed = window.confirm(
      'Очистити історію чату з цим персонажем? Цю дію неможливо скасувати.'
    );
            ...
            {!rightPaneHasContent && (
              ...
              >
                <span className="text-sm">
                  Обери персонажа зі списку зліва
                </span>
